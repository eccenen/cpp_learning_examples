...
class ModelTesterServer:
    def __init__(self, port=9999, model_dir="/home/admin/test/model", 
    ...
    def run_model(self, model_name, model_path):
        """
        运行模型
    ...
    def handle_client(self, conn, addr):
        ...
        try:
            ...
            # 运行模型
            result = self.run_model(model_name, model_path)
...
def main():
    ...
    parser.add_argument('--model-dir', default='/home/admin/test/model', 
                        help='模型存放目录 (默认: /home/admin/test/model)')
    parser.add_argument('--runner', default='/home/admin/test/bin/npu_runner',
